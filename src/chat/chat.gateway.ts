...
import { MessageInterface } from './dto/message.dto';
  ...
  export class ChatGateway {
    ...
    async listenForMessages(
      ...
      console.log('send_messagesend_messagesend_message')
      console.log(message)
      return ''
    //   const savedMessage = await this.chatService.saveChat(message, message.senderId);
    ...
    //     this.server.to(userReceive.socketId).emit('receiveMessage', savedMessage);
    //   }
    }
  }
